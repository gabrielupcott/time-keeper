...
zip -r time-keeper-firefox.zip background.js content.js manifest.json popup.html popup.js icons README.md

# Create Chrome build
echo "Creating Chrome build..."
cp manifest.chrome.json manifest.json
zip -r time-keeper-chrome.zip background.js content.js manifest.json popup.html popup.js icons README.md
